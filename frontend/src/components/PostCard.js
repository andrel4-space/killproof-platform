...
export default function PostCard({ post, onValidate }) {
  ...
  return (
    <div className="bg-white rounded-xl border border-zinc-200 shadow-[0_2px_8px_rgba(0,0,0,0.04)] overflow-hidden hover:shadow-[0_8px_24px_rgba(0,0,0,0.08)] transition-shadow" data-testid="post-card">
      ...
      <div className="p-6">
        <div className="mb-4">
          <h3 className="text-xl font-medium text-zinc-950 mb-2" data-testid="post-title">
            {post.title}
          </h3>
        ...
        <div className="flex items-center justify-between pt-4 border-t border-zinc-200">
          ...
          {post.is_validated_by_me ? (
            ...
            <Button
              ...
              className="h-11 px-6 rounded-full bg-[#BEF264] text-[#1A2E05] font-bold uppercase tracking-wide hover:brightness-110 active:scale-95 transition-all shadow-[0_0_20px_rgba(190,242,100,0.3)]"
